...
import type { Issue, Notification, Task, WorkspaceFile } from "../../models/types";
  ...
  return (
    <div>
      ...
      <div className="stat-grid">
        <div className="stat-card"><span className="stat-label">Tasks</span><strong>{tasks.length}</strong></div>
        <div className="stat-card"><span className="stat-label">Issues</span><strong>{issues.length}</strong></div>
